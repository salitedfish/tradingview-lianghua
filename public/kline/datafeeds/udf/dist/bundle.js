...
(function (e) {
  ...
  var i = function () {
    ...
    a = function () {
      function e(e, t) {
        ...
        window.KLINEINTERVALS.push(setInterval(this._updateData.bind(this), t))
      }
  ...
  var u = function () {
    function e(e) {
      this._subscribers = {}, 
      this._requestsPending = 0, this._quotesProvider = e, 
      window.KLINEINTERVALS.push(setInterval(this._updateQuotes.bind(this, 1), 1e4)), 
      window.KLINEINTERVALS.push(setInterval(this._updateQuotes.bind(this, 0), 6e4))
    }
